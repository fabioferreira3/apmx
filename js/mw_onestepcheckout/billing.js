$MW_Onestepcheckout(function(){
	...
	if(valid_vat()){
		...
		$MW_Onestepcheckout('#billing\\:taxvat').blur(function(event){ //$MW_Onestepcheckout('#billing\\:postcode').live("blur", function(){//	$MW_Onestepcheckout('#billing\\:postcode').blur(function(event){
