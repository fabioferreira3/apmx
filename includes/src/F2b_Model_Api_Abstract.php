...
/**
 * Abstract class for F2b API wrappers
 */
abstract class F2b_Model_Api_Abstract extends Varien_Object
{
    ...
    {
        if (!$this->hasData($key)) {
             $value = Mage::getStoreConfig('f2b/wpp/'.$key);
    ...
    {
        return Mage::getUrl($this->getConfigData('api_error_url', 'f2b/express/error'));
    }
    ...
    {
        return Mage::getUrl($this->getConfigData('api_return_url', 'f2b/express/return'));
    }
    ...
    {
        return Mage::getUrl($this->getConfigData('api_cancel_url', 'f2b/express/cancel'));
    }
    ...
    {
        $types = array('AE'=>Mage::helper('f2b')->__('Amex'), 'VI'=>Mage::helper('f2b')->__('Visa'), 'MC'=>Mage::helper('f2b')->__('MasterCard'), 'DI'=>Mage::helper('f2b')->__('Discover'));
