...
/**
 * Turnkeye Facebook Product Tab data helper
 *
 * @category   Turnkeye
 * @package    Turnkeye_FacebookProductsTab
 * @author     Viacheslav Fedorenko <v.fedorenko@turnkeye.com>
 */
class Turnkeye_FacebookProductsTab_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
        return $this->__('Facebook Product Tab');
    }
